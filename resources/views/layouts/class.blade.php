            ...
            <div class="container pr-5">
                <div class="row">
                            ...
                            @foreach ($class as $value)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('edit-class',['id'=>$value->id]) }}" class="btn btn-dark btn-sm">Edit</a>
                                        <a href="{{ route('delete-Class',['id'=>$value->id]) }}" class="btn btn-danger btn-sm">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <button class="btn btn-dark"
                        ...
                        <a href="{{ route('classform') }}" style="text-decoration: none; color:#ffff">Add class</a>
                    </button>
                </div>
            </div>
        </div>
